...
def assign_variables(values):
    ...
    'L3_current_building',
    'L1_current_solar',
    'Button_set_charging_current',
    'Main_fuse_rating',
    'Charging_cable_max_current',
    'Vreg1_set_charging_current',
    'Vreg2_set_charging_current',
    'Station_max_charging_current',
    'Dinamic_charging_current_limit',
    'Solar_charging_enable',
    'RFID_enable',
    'PWMRegister_ESP32_reply_Amps',
    'Solar_charging_enable_ESP32_reply',
    'TCA0_cmp2',
    'Dinamic_Enable',
    ...
    'Since_last_reset_energy',
    'Lifetime_energy',
    'PWMRegister_ESP32_slider_Amps',
    'WiFi_to_network_enable',
    'Total_house_power',
    'House_energy',
    'Solar_phases',
    'House_phases',
    ...
    'Solar_energy',
    'Solar_SURPLUS_power',
    'WiFi_to_network_state',
    'Local_network_IP_string',
    'ESP32_timer_delay',
    'HC12_enable',
    'number_of_stations',
    'HC12_Channel',
